//
//  CombineCollectionListSectionController.swift
//  AktaFeedCreator
//
...
import UIKit
import IGListKit
class CombineCollectionListSectionController: ListSectionController {
    ...
    func configureFeedItem(index : Int) -> SingleButtonCell {
        ...
        cell.rightArrow.image = UIImage.fontAwesomeIcon(name: .compress, textColor: aktaBlue, size: CGSize(width: 32, height: 32), backgroundColor: UIColor.clear)
        return cell
    }
